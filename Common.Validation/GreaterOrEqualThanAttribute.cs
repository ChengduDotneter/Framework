...
namespace Common.Validation
{
    public class GreaterOrEqualThanAttribute : ValidationBaseAttribute
    {
        ...
        public GreaterOrEqualThanAttribute(object greaterThanValue) => m_greaterThanValue = greaterThanValue;

        protected override string GetErrorMessage(ValidationContext validationContext, string propertyName) => $"{propertyName}必须大于或等于{GetGreaterThanText(validationContext, m_greaterThanValue)}。";
