...
//     {
//         Task RecieveMessage(object parameter);
//     }
//
//     public interface IMessageReciever<T> : IMessageReciever
//     {
//         Task RecieveMessage(T parameter);
//     }
//
//     public interface IMessageHandler
//     {
//         void AddReciever<T>(IMessageReciever<T> messageReciever);
//
//         Task SendMessage<T>(T parameter);
//     }
//
//     /// <summary>
//     /// WebSocket注册接口
